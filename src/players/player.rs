...
use crate::engine::context::Context as EngineContext;
...
impl From<EngineContext> for Context {
    fn from(value: EngineContext) -> Self {
        Self {
            health: value.health(),
            max_turns: value.max_turns(),
            player_details: value.player_details().clone(),
            position: value.position().clone(),
            previous_action: value.previous_action().clone(),
            scan: value.scanned_data().clone(),
            turn: value.turn(),
